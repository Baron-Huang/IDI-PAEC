...
#### Attempt: Testing and Traning GGO-ISDC main function on the AMU_CSCC dataset
'''
Paper Title:
...
if __name__ == '__main__':
    ...
    paras.add_argument('--class_num', type=int, default=3)  #AMU_CSCC: 5
    ...
    paras.add_argument('--feats_save_path', type=str,
                       default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Features/AMU_CSCC/IGI_PAEC')
    paras.add_argument('--layers_save_path', type=str,
                       default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Layers/AMU_CSCC/IGI_PAEC')
    paras.add_argument('--relations_save_path', type=str,
                       default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Relations/AMU_CSCC/IGI_PAEC')
    ...
    paras.add_argument('--resu_text_path', type=str,
     default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Our_wegts/AMU_CSCC/IGI_PAEC_AMU_CSCC_train_log.txt')

    paras.add_argument('--train_read_path', type=str,
                default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Datasets/AMU_CSCC/CSCC_WSI_with_PE/Train')
    paras.add_argument('--test_read_path', type=str,
                default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Datasets/AMU_CSCC/CSCC_WSI_with_PE/Test')
    paras.add_argument('--val_read_path', type=str,
                default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Datasets/AMU_CSCC/CSCC_WSI_with_PE/Test')

    paras.add_argument('--weights_save_path', type=str,
        default=r'/mnt/Weights_Result_Text/IGI_PAEC/DHMC_Lung/IGI_PAEC_AMU_CSCC.pth')
    paras.add_argument('--test_weights_path', type=str,
            default=r'/root/autodl-tmp/Weights_Result_Text/IGI_PAEC/CAMELYON16/AMU_CSCC.pth')

    ### Parallel save
    paras.add_argument('--weights_save_feature', type=str,
     default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Our_wegts/AMU_CSCC/IGI_PAEC_AMU_CSCC_feature.pth')
    paras.add_argument('--weights_save_head',  type=str,
     default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Our_wegts/AMU_CSCC/IGI_PAEC_AMU_CSCC_head.pth')
    ...
    if args.data_parallel == False:
        ...
        IGI_PAEC_feature = IGI_PAEC_Parallel_Feature(base_model=swinT_base, pooling_size=9, train_mode='partial')
        IGI_PAEC_head = IGI_PAEC_Parallel_Head(base_model=swinT_base, class_num=args.class_num, model_stats=args.run_mode,
                                               batch_size=args.batch_size, bags_len=args.bags_len, inhib_rate=0.1,
                                               inhib_lr_rate=0.1, end_no = -64)
    ...
    if args.run_mode == 'test':
        ...
        if args.data_parallel == False:
            ...
            get_feats = Get_Features(layer=IGI_PAEC_head.pooling, end_no=-64, save_path=args.feats_save_path)
