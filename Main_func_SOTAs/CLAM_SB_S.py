...
class CLAM_SB(nn.Module):
    def __init__(self, feat_dim=512, gate=True, size_arg="small", dropout=False, k_sample=8, n_classes=2,
                 subtyping=False, instance_eval=False):
...
if __name__ == "__main__":
    ...
    weight_path = \
        r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Our_wegts/DHMC_Kidney/Other_models/CLAM_SB_S_DHMC_Kidney.pth'
    ...
    roc_save_path = r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Predictions/DHMC_Kidney/CLAM_SB_S'
    resu_text_path = \
        r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Our_wegts/DHMC_Kidney/Other_models/CLAM_SB_S_train_log.txt'
    layers_save_path = r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Layers/DHMC_Kidney/CLAM_SB_S'
    feats_save_path = r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Features/DHMC_Kidney/CLAM_SB_S'
    ...
    clammb_net = CLAM_SB(instance_eval=False, feat_dim=feat_dim, n_classes=num_classes, size_arg=size_arg).cuda(
        gpu_device)
    ...
    if mode_stats == 'train':
        ...
        get_layers(layer=clammb_net.classifiers, save_path=layers_save_path)

        ### get features
        from Results_codes.get_features import Get_Features

        get_feats = Get_Features(layer=clammb_net.attention_net[2], end_no=-5, save_path=feats_save_path,
        ...
        testing_for_clam(test_model=clammb_net, train_loader=new_train_loader, val_loader=val_loader,
                         proba_value=None, test_loader=test_loader, gpu_device=gpu_device,
                         out_mode=None, proba_mode=False, class_num=num_classes,
                         roc_save_path=roc_save_path, bags_stat=True, bag_relations_path=None,
                         resu_text_path=resu_text_path)
