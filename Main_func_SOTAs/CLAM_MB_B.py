...
class CLAM_MB(CLAM_SB):
    def __init__(self, feat_dim=1024, gate=True, size_arg="small", dropout=False, k_sample=3, n_classes=2,
                  subtyping=False, instance_eval=True):
...
if __name__ == "__main__":
    ...
    weight_path = \
        r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Our_wegts/DHMC_Kidney/Other_models/CLAM_MB_B_DHMC_Kidney.pth'
    ...
    roc_save_path = r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Predictions/DHMC_Kidney/CLAM_MB_B'
    resu_text_path = \
        r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Our_wegts/DHMC_Kidney/Other_models/CLAM_MB_B_train_log.txt'
    layers_save_path = r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Layers/DHMC_Kidney/CLAM_MB_B'
    feats_save_path = r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Features/DHMC_Kidney/CLAM_MB_B'
    ...
    if mode_stats == 'train':
        training_for_clam(mil_net=clammb_net, train_loader=train_loader, val_loader=val_loader, test_loader=test_loader,
                          ...
                          data_parallel=False, weight_path=weight_path, proba_value=0.85, class_num = num_classes, bags_stat = True,
