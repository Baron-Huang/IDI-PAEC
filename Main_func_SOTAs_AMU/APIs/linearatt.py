...
from Main_func_SOTAs.APIs.incremental_decode_utils import with_incremental_state
from Main_func_SOTAs.APIs.quant_noise import quant_noise
...
class MultiheadLinearAttention(nn.Module):
    ...
    def forward(
        ...
        attn_weights_float = nn.Softmax()(attn_weights)
