...
if __name__ == "__main__":
    random_seed = 1
    batch_size = 1
    num_classes = 3  # CAMELYON16: 2, LSCC: 5, AMU: 3
    epoch = 100
    gpu_device = 3
    mode_stats = 'test'  # train or test
    weight_path = \
        r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Our_wegts/AMU_LSCC/Other_models/AB_MIL_G_AMU_LSCC.pth'
    ...
    roc_save_path = r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Predictions/AMU_LSCC/AB_MIL_G'
    resu_text_path = \
        r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Our_wegts/AMU_LSCC/Other_models/AB_MIL_G_train_log.txt'
    layers_save_path = r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Layers/AMU_LSCC/AB_MIL_G'
    feats_save_path = r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Features/AMU_LSCC/AB_MIL_G'
