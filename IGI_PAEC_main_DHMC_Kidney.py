...
#### Attempt: Testing and Traning GGO-ISDC main function on the DHMC-Kidney dataset
'''
Paper Title:
...
if __name__ == '__main__':
    ...
    paras.add_argument('--class_num', type=int, default=5)  #DHMC_Kidney: 5
    paras.add_argument('--batch_size', type=int, default=1)
    paras.add_argument('--epochs', type=int, default=100)
    paras.add_argument('--img_size', type=list, default=[224, 224])
    ...
    paras.add_argument('--parallel_gpu_ids', type=list, default=[0, 1, 2])

    # results save path
    paras.add_argument('--feats_save_path', type=str,
                       default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Features/DHMC_Kidney/IGI_PAEC')
    paras.add_argument('--layers_save_path', type=str,
                       default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Layers/DHMC_Kidney/IGI_PAEC')
    paras.add_argument('--relations_save_path', type=str,
                       default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Relations/DHMC_Kidney/IGI_PAEC')

    paras.add_argument('--roc_save_path', type=str,
                default=r'/root/autodl-tmp/IGI_PAEC/Results/ROC/DHMC_Lung/IGI_PAEC_Lung.xlsx')
    paras.add_argument('--resu_text_path', type=str,
     default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Our_wegts/DHMC_Kidney/IGI_PAEC_DHMC_Kidney_train_log.txt')

    paras.add_argument('--train_read_path', type=str,
                default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Datasets/DHMC_Kidney/Kidney_WSI_with_PE/Train')
    paras.add_argument('--test_read_path', type=str,
                default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Datasets/DHMC_Kidney/Kidney_WSI_with_PE/Test')
    paras.add_argument('--val_read_path', type=str,
                default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Datasets/DHMC_Kidney/Kidney_WSI_with_PE/Test')

    paras.add_argument('--weights_save_path', type=str,
        default=r'/mnt/Weights_Result_Text/IGI_PAEC/DHMC_Lung/IGI_PAEC_DHMC_Lung.pth')
    paras.add_argument('--test_weights_path', type=str,
            default=r'/root/autodl-tmp/Weights_Result_Text/IGI_PAEC/CAMELYON16/IGI_PAEC_DHMC_Lung.pth')

    ### Parallel save
    paras.add_argument('--weights_save_feature', type=str,
     default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Our_wegts/DHMC_Kidney/IGI_PAEC_DHMC_Kideny_feature.pth')
    paras.add_argument('--weights_save_head',  type=str,
     default=r'/home/dataset-hpfs-0/Kevin_Huang/IGI_PAEC_public/Results/Our_wegts/DHMC_Kidney/IGI_PAEC_DHMC_Kideny_head.pth')
    ...
    if args.data_parallel == False:
        ...
        IGI_PAEC_feature = IGI_PAEC_Parallel_Feature(base_model=swinT_base, pooling_size=49, train_mode='partial')
    ...
    if args.run_mode == 'test':
        ...
        if args.data_parallel == False:
            ...
            get_feats = Get_Features(layer=IGI_PAEC_head.pooling, end_no=-5, save_path=args.feats_save_path)
